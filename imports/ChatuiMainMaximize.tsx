  ...
  return (
    <div className="relative shrink-0 size-[24px]" data-name="ic-minimize">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="ic-minimize">
          <path d={svgPaths.p8b89dc0} id="Icon" stroke="var(--stroke-0, black)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.2" />
        </g>
      </svg>
    </div>
  );
...
export default function ChatuiMainMaximize({ messages, onSubmit, scrollContainerRef, isToggling, onBackToMain }: ChatuiMainMaximizeProps) {
  return (
    <div className="bg-white box-border content-stretch flex flex-col items-center overflow-clip relative rounded-[6px] w-[680px] min-h-[668px] max-h-[760px]" data-name="chatui-main-maximize">
      <Header onBackClick={onBackToMain} showBackButton={messages.length > 0} isMaximized={true} />
      {messages.length === 0 ? (
