...
import icSizeUrl from "../imports/ic_size.svg";
...
function IcShare() {
  return (
    <div
      ...
      data-name="ic-share"
    >
      <img src={icSizeUrl} alt="guide icon" width={16} height={16} className="block size-full" />
    </div>
  );
}
    ...
    >
      <div className="content-stretch flex flex-col gap-[10px] items-center leading-[0] relative shrink-0 text-center text-nowrap">
        ...
        <div className="flex flex-col font-['Pretendard_Variable',_sans-serif] justify-center relative shrink-0 text-[#6e6e6e]">
          ...
          >
            Staix 사용 가이드에 대해 도움을 드릴 수 있는 챗봇입니다.<br />
            무엇을 도와드릴까요?
          </p>
        </div>
      </div>
...
function Faq({
  ...
  return (
    ...
    >
      {Array.from([
        "워크스페이스 멤버 초대 어떻게 해?", "AI 게이트웨이 멤버 역할에 대해 알려줘", "결제 수단 등록하는 절차 알려줘"
      ]).map((question) => (
